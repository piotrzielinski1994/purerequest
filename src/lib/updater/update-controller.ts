...
// Port for the app-update boundary. The native impl wraps the Tauri updater +
// process plugins; browser/test builds use the noop. Kept behind a port so the
// startup checker and Settings section stay unit-testable without a Tauri host.
